<?php
/**
 * pluginseditor_setting.php
 * design by GodSon Improved by Mike
 */
...
<link rel="stylesheet" href="../content/plugins/pluginseditor/CodeMirror/codemirror.css">
<link rel="stylesheet" href="../content/plugins/pluginseditor/CodeMirror/theme/<?php echo CODEMIRROR_THEME;?>.css" id="mirrTheme">
<script src="../content/plugins/pluginseditor/CodeMirror/codemirror.js"></script>
<script src="../content/plugins/pluginseditor/CodeMirror/util.js"></script>

<script src="../content/plugins/pluginseditor/CodeMirror/mode.js"></script>
...
<div style="width:100%;float:left;">
    <div style="float:left;"><h3 style="margin: 0;padding:0;">当前编辑 <?php echo $themeName; ?> 插件的文件：<?php echo $themeFileName; ?></h3></div>
    <div style="float:right;">请选择要编辑的插件文件：<select onchange="changeSelectTheme(this)" id="themeName">
<?php
...
<hr/>
<div>作者：<a href="http://www.mikecoder.cn">Mike </a> 感谢:GodSon, Easyui 中文社区</a></div>
<style type="text/css">
...
function selectTheme() {
    ...
    $.post("../content/plugins/pluginseditor/pluginseditor_controler.php",{action:"saveEditorThemes",name:theme});
}

function changeSelectTheme(target){
    window.location.replace('./plugin.php?plugin=pluginseditor&themeName='+$(target).val());
}
function changeSelectThemeFile(target){
    window.location.replace('./plugin.php?plugin=pluginseditor&themeName='+$("#themeName").val()+"&themeFileName="+$(target).val());
}
var saving = false;
function saveFileContent(){
    if(!saving){
        ...
        $.post("../content/plugins/pluginseditor/pluginseditor_controler.php",{action:"save",themeName:$("#themeName").val(),fileName:$("#themeNameFile").val(),content:CodeMirrorEditor.getValue()},function(rsp){
            if(rsp.status){
